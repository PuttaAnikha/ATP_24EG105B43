...
function app(){
  ...
  //react element 
 //return react element-it should return only one element, multi elements cannot be returned (here div is one element)
 return(
  <div className='m-20'>
    ...
    <Product  productObj={products[7]}/>
    <Product  productObj={products[8]}/>
