    ...
    <div className='flex flex-col items-center gap-6'>
      <div className='relative'>
        ...
        <div className='relative bg-slate-900 border border-slate-700 w-24 h-24 rounded-full flex items-center justify-center'>
          <div className='text-4xl font-bold text-blue-400'>{counter}</div>
        </div>
      </div>
      ...
      <div className='flex gap-4 w-full'>
        ...
        <button 
          ...
          className='flex-1 py-3 px-4 bg-blue-600 hover:bg-blue-500 rounded-xl font-bold transition-all active:scale-95 shadow-lg shadow-blue-500/20'
        >
          +
        </button>
      </div>
