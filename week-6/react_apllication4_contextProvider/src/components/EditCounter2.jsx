    ...
    <div className='flex flex-col items-center gap-6'>
      <div className='relative'>
        ...
        <div className='relative bg-slate-900 border border-slate-700 w-24 h-24 rounded-full flex items-center justify-center'>
          <div className='text-4xl font-bold text-emerald-400'>{counter}</div>
        </div>
      </div>
      ...
      <div className='flex gap-4 w-full'>
        ...
        <button 
          ...
          className='flex-1 py-3 px-4 bg-emerald-600 hover:bg-emerald-500 rounded-xl font-bold transition-all active:scale-95 shadow-lg shadow-emerald-500/20'
        >
          +
        </button>
      </div>
