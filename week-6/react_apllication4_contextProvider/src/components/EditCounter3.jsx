  ...
  return (
    <div className='flex flex-col items-center gap-6'>
      <div className='relative'>
        <div className='absolute -inset-1 bg-purple-500 rounded-full blur opacity-25'></div>
        <div className='relative bg-slate-900 border border-slate-700 w-24 h-24 rounded-full flex items-center justify-center'>
          <div className='text-4xl font-bold text-purple-400'>{counter}</div>
        </div>
      </div>
      ...
      <div className='flex gap-4 w-full'>
        ...
        <button 
          ...
          className='flex-1 py-3 px-4 bg-purple-600 hover:bg-purple-500 rounded-xl font-bold transition-all active:scale-95 shadow-lg shadow-purple-500/20'
        >
          +
        </button>
      </div>
